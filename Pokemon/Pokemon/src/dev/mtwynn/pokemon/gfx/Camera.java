...
//creates a camera that alters the rendition of tiles on the JFrame to form the
...
public class Camera {
	...
	//handles the camera so that it stops scrolling once there are no more
	//tiles to display. Otherwise, the white space occupied by the Java Canvas 
	//which lies outside of the world is visible.
