...
public class Assets {
	...
	public static void init() {
		...
		//Game Buttons
		SpriteSheet startButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/StartButton.png"));
		SpriteSheet htpButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/HTPButton.png"));
		SpriteSheet backButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/BackButton.png"));
		SpriteSheet YNButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/YesNoButton.png"));
		
		//Battle Mode Buttons
		SpriteSheet AttButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/AttButton.png"));
		SpriteSheet SwapButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/SwapButton.png"));
		SpriteSheet FFButton = new SpriteSheet(ImageLoader.loadImage("/textures/buttons/FFButton.png"));
