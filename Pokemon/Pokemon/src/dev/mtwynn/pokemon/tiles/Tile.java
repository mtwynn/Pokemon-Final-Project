...
//Creates a tile based on the tile ID given to it in this class, as well as
//graphics imported from the Assets class.
public class Tile {
	//Tile ID's
	...
	public static Tile sHillTile = new SHillTile(10);
	//Tile variables
